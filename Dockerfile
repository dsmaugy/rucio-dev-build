...
## install utils, TODO: EDIT, GETS RID OF NTP/NTPUPDATE SINCE THEY'RE DEPRECATED
RUN yum install -y wget net-tools iproute openssh openssh-server openssh-clients openssl-libs tcpdump telnet chrony
# ntp ntpupdate
